...
//	string dataset_path = "/home/aron/evaluate/dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
...
//	string image_path = "/input/in%06d.jpg"; //path to images - this format allows to read consecutive images with filename inXXXXXX.jpq (six digits) starting with 000001
	...
	string dataset_path = "/home/aron/dataset/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
   ...
   // if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/aron/AVSA2020results/"; //SET THIS DIRECTORY according to your project
	string project_name = "Lab3.1AVSA2020"; // project exe name
	string results_path = project_root_path+"/"+project_name+"/please";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			int threshold_ghosts2 = 70;  // to set ... //Lab1.1.3
			bool rgb = true; //true;
			double alpha2 = 0.5, beta = 0.9;    // shadow detection Arguments
		    double th = 36 , ts = 0.1 ;        // thresholds for shadow detection


		    // Improvement : Selective Running Average Background Model Update

			fgseg::bgs avsa_bgs(tau, alpha, selective_bkg_update, threshold_ghosts2, rgb ,alpha2 ,beta ,ts ,th ); //construct object of the bgs class
		...
		for (;;) {
		        ...
		        //...
           		...
           		avsa_bgs.running_average();
           		avsa_bgs.suppression_stationary();
